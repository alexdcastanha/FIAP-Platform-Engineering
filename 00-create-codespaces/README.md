...
2. Primeiro vamos fazer o fork do repositório que contém os exercícios da disciplina. Acesse o link [FIAP-Platform-Engineering](https://github.com/vamperst/FIAP-Platform-Engineering)
...
7. Deixe as opções da tela da seguinte forma e clique em `Create Codespace`:
   1. repository: `FIAP-Platform-Engineering`
   2. Branch: `master`
